...
@Autonomous(name="StatesAutoFullRed", group="Hardware Test")
@Disabled
public class StatesAutoFullRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        r.TankForward(.25, 525); //Drive to Foundation
