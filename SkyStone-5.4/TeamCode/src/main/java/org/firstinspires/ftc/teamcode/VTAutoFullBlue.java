...
@Autonomous(name="VTAutoFullBlue", group="VT Auto")
public class VTAutoFullBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rotate(-89, 0.3); //Rotate to Foundation

        r.TankForward(0.8, 3700 - (50 * stone)); // Move past bridge was 3550
        ...
        rotate(-82, 0.3); //Rotate to Foundation
        r.TankForward(.25, 590); //Drive to Foundation was 525 was 555


        r.foundationMovePower(-1); //Grab Foundation
        Thread.sleep(500);
        r.TankForward(0.8, -1640); //Move forward with foundation was 1500 was 1600
        ...
        TankTurnWithArm(0.3, -2200, 0.15, 4);
        Thread.sleep(200);
